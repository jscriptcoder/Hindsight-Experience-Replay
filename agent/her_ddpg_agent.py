...
class HerDDPGAgent(HerAgent):
    ...
    def __init__(self, config):
        ...
        self.actor_local = HerActor(config.state_size,
                                    config.action_size,
                                    config.hidden_actor,
                                    config.activ_actor)

        self.actor_target = HerActor(config.state_size,
                                     config.action_size,
                                     config.hidden_actor,
                                     config.activ_actor)
    ...
    def act(self, state, goal, train=True):
        ...
        with torch.no_grad():
            action = self.actor_local(state, goal).cpu().data.numpy()
    ...
    def learn(self, experiences):
        ...
        (states,
         ...
         next_states,
         dones, 
         goals) = from_experience(experiences, with_goal=True)
    ...
    def summary(self, agent_name='DDGP Agent + HER'):
